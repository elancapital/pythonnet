...
from clr_loader.ffi import ffi, load_hostfxr
from clr_loader.types import Runtime, RuntimeInfo, StrOrPath
from clr_loader.util import check_result

__all__ = ["DotnetCoreRuntimeCommandLine"]

_IS_SHUTDOWN = False


class DotnetCoreRuntimeCommandLine(Runtime):
    def __init__(self, entry_dll: Path, dotnet_root: Path, **params: str):
        ...
        self._handle = _get_handle(self._dll, self._dotnet_root, entry_dll)
...
def _get_handle(dll, dotnet_root: StrOrPath, entry_dll: StrOrPath):
